class FileManager():
    ...
    def WriteToFile(self, info):
        self.info = info
        with open(r"C:\Users\Bukhari\Desktop\python code\oops\CHATYBOTY\ASSETS\to do list.txt", "a") as file:
            file.write(self.info + "\n")

    def ReadFile(self):
        with open(r"C:\Users\Bukhari\Desktop\python code\oops\CHATYBOTY\ASSETS\to do list.txt", "r") as file:
